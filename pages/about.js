...
export default function Home() {
  ...
  return (
    <>
        <section className='grid grid-cols-1 md:grid-cols-2 mt-24 md:mt-12 bg-gray-900 bg-jack-bg bg-cover md:bg-contain bg-no-repeat bg-center md:bg-right h-screen'>
      ...
      <div className="my-4 logo-bg text-black">
