...
export default function About() {
  return (
    <div>
          <div className="container mx-auto m-4 md:mx-12 md:my-48 logo-bg text-black">
            <h2 className='pt-12 px-5 text-blue-300 text-5xl md:text-8xl'>A little about me....</h2>
