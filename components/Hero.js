...
export default function Home() {
  return (
    <div>
        <section className='grid grid-cols-1 md:grid-cols-2 mt-12 md:mt-12 bg-gray-900 bg-hero-bg md:bg-contain sm:bg-cover bg-no-repeat bg-top-right md:bg-right h-screen'>
